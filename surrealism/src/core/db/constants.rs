...
sql_const!(
    ...
    (HIGHLIGHTS,"HIGHLIGHTS") (EITHER,"??") (BOTH,"?:") (IS ,"=") (ISNOT,"!=") (HAS,"?=") (ALLEQ,"*=") (LIKE,"~") (NOTLIKE,"!~") (INLIKE,"?~")
    (POW,"**") (CONTAINSNOT,"CONTAINSNOT") (CONTAINSALL,"CONTAINSALL") (CONTAINSANY,"CONTAINSANY") (CONTAINSNONE,"CONTAINSNONE")
    (INSIDE,"INSIDE") (NOTINSIDE,"NOTINSIDE") (ALLINSIDE,"ALLINSIDE") (ANYINSIDE,"ANYINSIDE") (NONEINSIDE,"NONEINSIDE") (OUTSIDE,"OUTSIDE")
    (INTERSECTS,"INTERSECTS") (MATCHES,"@@") (ADD,"+") (MINUS,"-") (PLUS,"*") (DIVIDE,"/") (SELECT_ALL,"SELECT * FROM")
);
